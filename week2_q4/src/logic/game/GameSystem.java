...
public class GameSystem {
	...
	public BaseUnit promote(BaseUnit unit, int choice) {
		if (choice == 0)
			return new MeleeUnit(unit.getColumn(), unit.getRow(), unit.isWhite(), unit.getName());
		else if (choice == 1)
			return new RangeUnit(unit.getColumn(), unit.getRow(), unit.isWhite(), unit.getName());
		else if (choice == 2)
			return new FlyingUnit(unit.getColumn(), unit.getRow(), unit.isWhite(), unit.getName());
		return null;
	}
}
